...
This project is indexed by GitNexus as **EasyAgent** (4172 symbols, 9822 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
